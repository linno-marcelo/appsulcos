...
class MyApp(MDApp):
    ...
    def salvar_informacoes(self):
        ...
        try:
            ...
            ws = wb.active
            if ws.max_row == 1:
                ws.append(["Equipamento", "CS", "Data", "Código Pneu", "Sulco1", "Sulco2", "Sulco3", "Medida", "Calibrada"])
        except FileNotFoundError:
            wb = openpyxl.Workbook()
            ws = wb.active
            ws.append(["Equipamento", "CS", "Data", "Código Pneu", "Sulco1", "Sulco2", "Sulco3", "Medida", "Calibrada"])

        ws.append([dados["equipamento"], dados["cs"], dados["data"], dados["codigo_pneu"], dados["sulco1"], dados["sulco2"], dados["sulco3"], dados["medida"], dados["calibrada"]])
        wb.save("dados.xlsx")
